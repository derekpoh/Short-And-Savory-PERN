...
const CuisinePage = () => {
    ...
    return (
      <>
        { !isMobile ? (
        <SearchTitle><Typography variant="h4" marginTop="50px" marginBottom="50px" color="black" textTransform="uppercase" letterSpacing='0.1em' textOverflow="ellipsis" overflow="clip" width="1400px">Cuisine: "{cuisine}"</Typography></SearchTitle>
        ) : (
        <SearchTitle><Typography variant="h4" marginTop="50px" marginBottom="50px" color="black" textTransform="uppercase" letterSpacing='0.1em' fontSize="28px" textAlign='center' textOverflow="ellipsis" overflow="clip" width="345px">Cuisine:<br/> "{cuisine}"</Typography></SearchTitle>
        )}
